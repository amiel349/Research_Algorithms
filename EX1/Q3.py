import doctest
"""
in this question I got help from https://stackoverflow.com/questions/11089655/sorting-dictionary-python-3
"""
...
def print_sorted(x):
    """
    this method print the given element after it performs a deep sort
    :param x:
    :return: print the sorted element
    >>> print_sorted({"a":5,"c":6,"b":[1,3,2,4]})
    {'a': 5, 'b': [1, 2, 3, 4], 'c': 6}
    >>> print_sorted({6: 5, -3: 6, 4: ("a","z", "d","g" ,"h" )})
    {-3: 6, 4: ['a', 'd', 'g', 'h', 'z'], 6: 5}
    """
